...
(function () {
	...
	DPApp.ListViewBody = Mn.CollectionView.extend({
		tagName: 'ul',

		id: 'todo-list',

		childView: DPApp.TodoView,
	...
	DPApp.ListView = Mn.View.extend({
		...
		onRender: function () {
			this.showChildView('listBody', new DPApp.ListViewBody({
